...
from zeeref.actions.actions import Action
...
@patch(
    "zeeref.actions.actions.menu_structure", [{"menu": "Foo", "items": ["bar", "baz"]}]
)
...
@patch(
    "zeeref.actions.actions.menu_structure",
...
@patch(
    "zeeref.actions.actions.menu_structure",
    [{"menu": "Foo", "items": [{"menu": "Bar", "items": "_build_recent_files"}]}],
)
